...
def list_available_models(args):
    ...
    print("  gemini, gemini-pro     → google:gemini-3-pro-preview (temp=1.0)", file=sys.stderr)
    print("  gemini-flash, gemini-3-flash → google:gemini-3-flash-preview (temp=1.0)", file=sys.stderr)
